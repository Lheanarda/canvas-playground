        ...
        {!loading && (
          <>
            <Card outline className="col-span-2">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-3  mt-2">
                ...
                <StatisticSingle
                  ...
                  bgIconColor="bg-blue-200"
                  Icon={
                    <ChartSquareBarIcon className="text-blue-600 w-6 h-6" />
                  }
                />
              </div>
            </Card>
            ...
            <StatisticSingleCard
              ...
              bgIconColor="bg-blue-200"
              mode={width < SM_BREAKPOINT ? "col" : "row"}
              Icon={<DocumentAddIcon className="text-blue-600 w-6 h-6" />}
            />
            <StatisticSingleCard
              outline
              ...
              bgIconColor="bg-blue-200"
              mode={width < SM_BREAKPOINT ? "col" : "row"}
              Icon={<DocumentReportIcon className="text-blue-600 w-6 h-6" />}
            />
          </>
        )}
      </div>
